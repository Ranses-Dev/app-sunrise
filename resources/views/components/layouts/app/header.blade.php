...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:header container class="border-b border-zinc-200 bg-black dark:border-zinc-700 dark:bg-zinc-900">
    ...
    <flux:sidebar stashable sticky
        class="lg:hidden border-r border-zinc-200 bg-zinc-500 dark:border-zinc-700 dark:bg-zinc-900">
