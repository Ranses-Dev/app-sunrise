<div class="space-y-4">
    <flux:heading>List Health Care Providers</flux:heading>
    ...
    <flux:table :paginate="$this->results">
        <flux:table.columns>
            ...
            <flux:table.column>Plans</flux:table.column>
        ...
        <flux:table.rows>
            @foreach ($this->results as $result)
                <flux:table.row :key="$result->id">
                    ...
                    <flux:table.cell> @foreach ($result->plans as $plan)
                        <flux:badge color="yellow">{{$plan->name}}</flux:badge>
                    @endforeach
                    </flux:table.cell>
