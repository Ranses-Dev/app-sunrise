<div>
    ...
    <div class="form">
        <form wire:submit.prevent="store">
            ...
            @if ($client)
                <flux:label>Client Number</flux:label>
                <flux:input type="text" wire:model="form.mealClientNumber" placeholder="Enter client number..." />
            @endif
            <div class="col-span-1">
            ...
            <div class="col-span-1">
                ...
                <flux:select wire:model="form.deliveryCostId" variant="combobox" placeholder="Choose delivery cost..."
                    clearable>
            ...
            <div class="col-span-1">
                ...
                <flux:select wire:model="form.selectedDays" variant="combobox" placeholder="Choose delivery days..."
                    clearable>
