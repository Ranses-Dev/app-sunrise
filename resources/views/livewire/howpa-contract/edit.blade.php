<div>
    <x-page-heading title="Edit HOPWA Contract" />
    <div class="form">
        <form wire:submit.prevent="save">
            ...
            <div class="space-y-4">
                ...
                @if ($this->form->client)
                    ...
                    <flux:select label="Income Type" wire:model.live='form.incomeTypeId' clearable variant="listbox"
                        searchable placeholder="Income Types...">
                    ...
                    <flux:date-picker label="Enrollment Day" wire:model='form.enrollmentDay' selectable-header with-today />
                    <flux:date-picker label="Re-Certification Date" wire:model='form.reCertificationDate' selectable-header
                        with-today />
                    <flux:switch label="Is Active" align="left" wire:model="form.isActive" />

                    <flux:select label="Program Branch" wire:model.live='form.programBranchId' clearable variant="listbox"
                        searchable placeholder="Program Branches...">
                    ...
                    <flux:select label="Client Service Specialist" wire:model='form.clientServiceSpecialistId' clearable
                        variant="listbox" searchable placeholder="Client Service Specialists...">
                    ...
                    <flux:select wire:model='form.clientPhoneNumberId' label="Phone" variant="listbox" clearable searchable
                    ...
                    <flux:input type="number" label="Number of Bedrooms Required" wire:model='form.numberBedroomsReq' />
