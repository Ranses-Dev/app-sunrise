...
<div>
    ...
    <flux:modal name="search" wire:model='showModal' class="w-full h-[90vh] max-w-7xl overflow-y-auto">
        <div class="space-y-6">
            <x-page-heading title="Clients" />
            <div class="space-y-4 w-full">
                <div class="w-1/2">
                    <flux:input wire:model.live.debounce1000="search" icon="magnifying-glass"
                        placeholder="Search ..." />
                </div>
