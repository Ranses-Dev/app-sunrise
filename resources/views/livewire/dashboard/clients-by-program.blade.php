<div class="bg-transparent rounded-xl shadow p-4 w-full   mx-auto">
    @if(count($this->clientsByProgram()) > 1)
        <div class="mb-3 flex justify-between items-center">
            <h2 class="text-sm font-semibold text-gray-700">Clients by Health Care Provider</h2>
        </div>
        <flux:chart :value="$this->clientsByProgram" class="aspect-3/1">
            <flux:chart.svg>
                <flux:chart.line field="total" class="text-blue-500 dark:text-blue-400" />
                <flux:chart.axis axis="x" field="provider">
            ...
            <flux:chart.tooltip>
                <flux:chart.tooltip.heading field="provider" />
