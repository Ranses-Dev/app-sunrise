<div class="flex  flex-col justify-center items-center">
    <form wire:submit.prevent="store" class="form">
        <flux:heading>Create Program Branch</flux:heading>
        <flux:select label="Programs" wire:model="form.programId" variant="listbox" searchable clearable placeholder="Choose programs...">
