...
class IdentificationTypePolicy
{
     ...
     */
    public function restore(User $user, IdentificationType $identificationType): bool
    {
        return true;
    }
     ...
     */
    public function forceDelete(User $user, IdentificationType $identificationType): bool
    {
        return true;
    }
}
